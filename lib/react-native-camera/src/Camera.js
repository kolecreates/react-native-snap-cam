...
export default class Camera extends Component {
  ...
  async componentWillMount() {
    ...
    if (Platform.OS === 'ios') {
      ...
      const camera_granted = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.CAMERA, {
        title: this.props.permissionDialogTitle,
        message: this.props.permissionDialogMessage,
      });

      const audio_granted = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.RECORD_AUDIO, {
        title: this.props.permissionDialogTitle,
        message: this.props.permissionDialogMessage,
      });

      const write_media = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.WRITE_EXTERNAL_STORAGE, {
        title: this.props.permissionDialogTitle,
        message: this.props.permissionDialogMessage,
      });
