...
public class RCTCameraView extends ViewGroup {
  private static RCTCameraView instance;
    ...
    public static RCTCameraView getInstance(){
      return instance;
    }
    ...
    public boolean isFlashMode(int mode){
      return this._flashMode == mode;
    }
    ...
    public RCTCameraViewFinder getViewFinder(){
      return _viewFinder;
    }
